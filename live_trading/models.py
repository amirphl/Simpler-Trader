...
class LiveTradingConfig:
    ...
    # Scheduling
    candle_ready_delay_seconds: int = 30  # Delay after timeframe close to ensure candle availability
    ...
    def __post_init__(self) -> None:
        ...
        if self.timeframe not in ["1m", "3m", "5m", "15m", "30m", "1h", "2h", "4h", "6h", "12h", "1d"]:
...
class TradingState:
    ...
    def is_symbol_disabled(self, symbol: str, current_time: datetime, disable_hours: float) -> bool:
    ...
    def cleanup_disabled_symbols(self, current_time: datetime) -> None:
        ...
        expired = [
            symbol for symbol, until in self.disabled_symbols.items()
