"""PinBar Magic v3 live-trading entrypoint."""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Live trading bot for the PinBar Magic v3 strategy",
    ...
    parser.add_argument(
        ...
        type=float,
        default=1.0,
        help="Trailing activation distance in ticks",
    )
    parser.add_argument(
        "--trail-offset",
        type=float,
        default=1.0,
        help="Trailing stop offset in ticks",
    )
    parser.add_argument(
        "--symbol-mintick",
        type=float,
        default=1.0,
        help="Minimum symbol price tick for PinBar Magic v3 trail point conversion",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=float,
        default=5.0,
        help="Main live loop sleep interval in seconds",
    )
    parser.add_argument(
        "--trailing-check-interval-seconds",
        type=float,
        default=5.0,
        help="Minimum interval between tick-trailing checks in seconds",
    )
...
def main(argv: Optional[List[str]] = None) -> int:
    ...
    return _shared.run_main(
        ...
        argv=_force_strategy(effective_argv, "pinbar_magic_v3"),
    )
